<table class="table table-hover">
    ...
    <tr>
        ...
        <th class="hidden-xs">{!! Sortable::link('invoice_date', trans('fi.Invoice_date'), 'invoices') !!}</th>
        <th class="hidden-md hidden-sm hidden-xs">{!! Sortable::link('invoices_custom.event_date', 'Event Date', 'invoices') !!}</th>
	<th class="hidden-xs">Payment Due Date</th>
    ...
    @foreach ($invoices as $invoice)
        <tr>
            <td><input type="checkbox" class="bulk-record" data-id="{{ $invoice->id }}" value="{{ $invoice->id }}"></td>
	        ...
	        <td class="hidden-md hidden-sm hidden-xs">{{ $invoice->quote->formatted_event_date }}</td>
	        @else
	        <td class="hidden-md hidden-sm hidden-xs">{{ $invoice->getFormattedInvoiceEventDateAttribute() }}</td>
            @endif
	    <td class="hidden-xs">{{ $invoice->formatted_due_at }}</td>
