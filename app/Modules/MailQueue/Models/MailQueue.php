    ...
    */
    ...
    public function scopeKeywords($query, $keywords = null)
    {
        if ($keywords)
        {
            ...
            $query->where('mail_queue.created_at', 'like', '%' . $keywords . '%')
                ->orWhere('mail_queue.from', 'like', '%' . $keywords . '%')
                ->orWhere('mail_queue.to', 'like', '%' . $keywords . '%')
                ->orWhere('mail_queue.cc', 'like', '%' . $keywords . '%')
                ->orWhere('mail_queue.bcc', 'like', '%' . $keywords . '%')
                ->orWhere('mail_queue.subject', 'like', '%' . $keywords . '%');
        }
