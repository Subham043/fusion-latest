<table class="table table-hover">
    ...
    <tr>
        ...
        <th class="hidden-xs">{!! Sortable::link('event_date', trans('fi.event_date'), 'quotes') !!}</th>
        <th class="hidden-xs">{!! Sortable::link('quote_date', trans('fi.quote_date'), 'quotes') !!}</th>
    ...
    @foreach ($quotes as $quote)
        <tr>
            ...
            <td class="hidden-xs">{{ $quote->formatted_event_date }}</td>
